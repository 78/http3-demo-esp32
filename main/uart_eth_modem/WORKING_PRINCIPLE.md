...
| DoTransmit() | 获取 | UartUhci::DoTransmit() |
| HandleGdmaTxDone() | 释放 | UartUhci::HandleGdmaTxDone() |
...
// 超时参数
static constexpr int64_t kIdleTimeoutUs = 300 * 1000;   // 300ms 空闲超时
static constexpr int64_t kAckTimeoutUs = 100 * 1000;     // 100ms ACK 超时
